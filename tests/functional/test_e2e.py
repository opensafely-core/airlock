...
def login_as(live_server, page, username):
    ...
    click_and_htmx(page, page.locator("button[type=submit]"))
...
def workspaces_dropdown(page):
    ...
    click_and_htmx(page, page.locator("#workspaces").first)
...
def test_e2e_release_files(
    ...
    click_and_htmx(page, page.get_by_test_id("nav-workspaces-requests"))
    ...
    click_and_htmx(page, page.get_by_role("link", name="Go to test-workspace"))
    ...
    click_and_htmx(page, page.locator("#tree").get_by_role("link", name="file.foo"))
    ...
    click_and_htmx(page, page.locator("#tree").get_by_role("link", name="file.txt"))
    ...
    click_and_htmx(page, add_file_button)
    ...
    click_and_htmx(page, subdir_link)
    ...
    click_and_htmx(page, page.locator("#workspace-home-button"))
    ...
    click_and_htmx(page, page.get_by_role("link", name="subdir"))
    click_and_htmx(page, supporting_file_link)
    ...
    click_and_htmx(page, filegroup_link)
    ...
    click_and_htmx(page, page.get_by_test_id("nav-account"))
    click_and_htmx(page, page.get_by_test_id("nav-logout"))
    ...
    # View requests
    click_and_htmx(page, page.get_by_test_id("nav-reviews"))

    # View submitted request (in the output-checker's outstanding requests for review)
    click_and_htmx(page, page.locator("#outstanding-requests").get_by_role("link"))
    ...
    click_and_htmx(page, request_changes_button)
    ...
    # Confirm that the saved comment is visible, and the Blinded and Private statuses
    # are displayed in pills
    comments_locator = page.locator("#selected-contents").locator(".comments")
    ...
    click_and_htmx(page, approve_file_button)
    ...
    click_and_htmx(page, file_link)
    click_and_htmx(page, page.locator("#file-button-more"))

    # Download the file
    with page.expect_download() as download_info:
        click_and_htmx(page, page.locator("#download-button"))
    ...
    click_and_htmx(page, page.locator("#request-home-button"))
    click_and_htmx(page, page.locator("#submit-review-button"))
    ...
    # Release the files
    click_and_htmx(page, release_button)
...
def test_e2e_update_file(page, live_server, dev_users, multiselect):
    ...
    if multiselect:
        ...
        click_and_htmx(page, page.locator('input[name="selected"]'))
    else:
        page.goto(live_server.url + workspace.get_url(UrlPath("subdir/file.txt")))

    # Find the add file button and click on it to open the modal
    click_and_htmx(page, page.locator("button[value=update_files]"))

    # Click the button to update the file in the release request
    click_and_htmx(page, page.get_by_role("form").locator("#update-file-button"))
...
def test_e2e_withdraw_and_readd_file(page, live_server, dev_users):
    ...
    click_and_htmx(page, page.locator("button[value=withdraw_files]"))
    expect(page.locator("body")).to_contain_text("has been withdrawn from the request")
    ...
    expect(page.locator(".clusterized")).to_be_visible()
    click_and_htmx(page, page.locator(f'input[name="selected"][value="{path1}"]'))
...
def test_e2e_reject_request(page, live_server, dev_users):
    ...
    # Reject request
    click_and_htmx(page, page.locator("button[data-modal=rejectRequest]"))
    click_and_htmx(page, page.locator("#reject-request-button"))
...
def test_e2e_withdraw_request(page, live_server, dev_users):
    ...
    click_and_htmx(page, page.locator("[data-modal=withdrawRequest]"))

    click_and_htmx(page, page.locator("#withdraw-request-confirm"))
...
def test_e2e_filter_submit(page, live_server, dev_users):
    ...
    click_and_htmx(page, page.locator("#requests-workspace-button"))
    ...
    click_and_htmx(page, page.locator("#clear-filter"))
...
def test_add_previously_released_txt_file_to_pending_request(
    ...
    factories.create_request_at_status(
        "workspace", author=user, files=files, status=RequestStatus.PENDING
    )
