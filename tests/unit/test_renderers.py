...
RENDERER_TESTS = [
    ...
    (".jpg", "text/html", False, "image.html"),
    (".jpeg", "text/html", False, "image.html"),
    (".png", "text/html", False, "image.html"),
    (".svg", "image/svg+xml", False, None),
    ...
    (".jpg", "text/html", True, "airlock/templates/file_browser/text.html"),
    (".jpeg", "text/html", True, "airlock/templates/file_browser/text.html"),
    (".png", "text/html", True, "airlock/templates/file_browser/text.html"),
    (".svg", "text/html", True, "airlock/templates/file_browser/text.html"),
